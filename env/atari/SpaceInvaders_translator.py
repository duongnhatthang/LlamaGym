...
class ObsTranslator:
    ...
    def translate(self, state):
        ...
        return (
            f"You are at position x={player_x}. "
...
class GameDescriber:
    ...
    def describe_game(self):
        return (
            "In the Space Invaders game, you control a spaceship and aim to destroy all the invaders while avoiding their attacks and protecting your lives. "
            f"There are {self.args.frameskip} frames per step and the action sticks for the skipping frames."
            if self.args.frameskip > 0
            else ""
    ...
    def describe_action(self):
        return (
            "Type 0 for NOOP (no operation), 1 to FIRE (trigger fire button), 2 to move RIGHT, 3 to move LEFT, 4 to move RIGHT and FIRE, 5 to move LEFT and FIRE. "
