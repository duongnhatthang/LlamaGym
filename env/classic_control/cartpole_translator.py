class ObsTranslator:
    ...
    def translate(self, state):
        ...
        res = (
            f"The cart is positioned at {cart_position:.3f}, with a velocity of {abs(cart_velocity):.2f} towards the {cart_direction}. "
...
class GameDescriber:
    ...
    def describe_game(self):
        return (
            "In the CartPole game, you control a cart that moves along a horizontal track. There is a pole "
