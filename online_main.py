...
if __name__ == "__main__":
    ...
    with open(f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_32b_1000_steps_withEps.pkl', 'rb') as file:
        pretrain_32b_1000_dqn = pickle.load(file)
    with open(f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_7b_1000_steps_withEps.pkl', 'rb') as file:
        pretrain_7b_1000_dqn = pickle.load(file)
    with open(f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_32b_3000_steps_withEps.pkl', 'rb') as file:
        pretrain_32b_3000_dqn = pickle.load(file)
    with open(f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_7b_3000_steps_withEps.pkl', 'rb') as file:
    ...
    with open('data/cache_'+hyperparams["env"].split('-')[0]+'_withEps.pkl', 'wb') as file:
