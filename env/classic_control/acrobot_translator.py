...
class ObsTranslator:
    ...
    def translate(self, state):
        ...
        res = (
            f"Link1: angle theta1 {theta1:.2f} radians, rotating {abs(theta1_dot):.2f} radians per second {theta1_direction}. "
...
class GameDescriber:
    ...
    def describe_action(self):
        return (
            "Type '1' to apply -1 torque, '2' to apply 0 torque, or '3' to apply 1 torque. "
...
class TransitionTranslator(ObsTranslator):
    def translate(self, infos, is_current=False):
        ...
        for i, info in enumerate(infos):
            ...
            action_desc = (
                f"Take Action: Apply {info['action'] - 2} torque on the actuated joint."
            )
