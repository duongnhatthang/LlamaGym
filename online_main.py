...
if __name__ == "__main__":
    ...
    if path_32b is not None:
        with open(
            f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_32b_1000_steps_{hyperparams["n_pretrain_eps"]}{suffix}.pkl',
            "rb",
        ) as file:
            pretrain_32b_1000_dqn = pickle.load(file)
        with open(
            f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_32b_3000_steps_{hyperparams["n_pretrain_eps"]}{suffix}.pkl',
            "rb",
        ) as file:
    ...
    if path_7b is not None:
        with open(
            f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_7b_1000_steps_{hyperparams["n_pretrain_eps"]}{suffix}.pkl',
            "rb",
        ) as file:
            pretrain_7b_1000_dqn = pickle.load(file)
        with open(
            f'models/{hyperparams["env"].split("-")[0]}_ddqn_pretrain_7b_3000_steps_{hyperparams["n_pretrain_eps"]}{suffix}.pkl',
            "rb",
        ) as file:
